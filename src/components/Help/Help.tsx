      ...
      <calcite-shell contentBehind={isSmall}>
        ...
        <calcite-panel>
          ...
          <p>
            ...
            Our goal is to support safer neighborhoods through a better-informed
            community and to strengthen community-oriented policing efforts.
          </p>
          <p>
            Crime Mapper uses an advanced mapping engine to provide interactive
            tools for viewing crime activity. Crime data is extracted on a
            regular basis from the Raleigh Police Department’s records system so
            the information available through your web browser is as current as
            possible.
          </p>
          ...
          <ul>
            ...
            <li>
              To enhance privacy and support accurate offense coding, incidents
              are displayed with a 1-day delay.
            </li>
            <li>
          ...
          <div className="col-2">
            <div>
              ...
              <h3>Filter</h3>
              Shows or hides the Filter panel, where you can filter incidents by
              What, Where and When
              <h3>Map</h3>
              ...
              <ul>
                ...
                <li>
                  If no other panel is visible, clicking Map does not change the
                  display.
                </li>
              </ul>
              <h3>Table</h3>
              Shows or hides the Table panel beneath the Map. The table displays
              ...
              <h3>Collapse</h3>
              Collapses the action bar to show icons only and hide text labels.
            </div>
            <img
          ...
          <p>
            To filter results, click one or more crime groups you are interested
            in. The map will update to show only incidents in the selected
            categories.
          </p>
          ...
          When one or more groups are selected, the Filter by Description button
          becomes available. Clicking this button displays a list of
          descriptions for the selected groups, allowing you to further refine
          your selection.
          <p>
            <img style={{ maxWidth: "500px" }} src="help/image006.png" />
          </p>
          In the list of descriptions, uncheck any you are not interested in and
          check the ones you want to include.
          <p>
            <img style={{ maxWidth: "500px" }} src="help/image007.png" />
          </p>
          <p>
            Use the Select All or Select None options to quickly select or clear
            all descriptions for a group.
          </p>
          <p>
          ...
          <ol>
            ...
            <li>
              <strong>Drawn Graphic</strong> – Draw a shape directly on the map
              to define an area. Crimes within this area will be displayed.
            </li>
          </ol>
          ...
          <div>
            <ol>
              ...
              <li>
                ...
                appears in the list of suggested addresses, click it to select.
              </li>
              <li>
              ...
              <li>
                <strong>Adjust Search Distance</strong> – By default, the buffer
                distance is set to 1 mile. You can adjust this distance by
                entering a new value in the text box (decimals are allowed). The
                units can also be changed between miles and feet.
                <p>
                  <img
              ...
              <li>
                The map will zoom to that area and filter the crimes on the map.
              </li>
            </ol>
          </div>
          ...
          <ol>
            <li>
              ...
              <ul>
                ...
                <li>
                  Hospitality District (Note: this is a single area and does not
                  have a list of districts.)
                </li>
              </ul>
            </li>
            <li>
              ...
              corresponding districts or places will appear. Check the ones you
              want to include in your filter. For those with a long list of
              places, you can type where it says Select Feature… to narrow down
              the list.
            </li>
            <li>
          ...
          <ol>
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  <strong>Line or Polygon:</strong> Click on the map to add each
                  vertex. When finished, double-click to complete the shape.
                </li>
                <li>
            ...
            <li>
              ...
              (and buffer applied, if desired), the map will update to show only
              the crimes within the defined area.
            </li>
          </ol>
          <h2 id="when">When</h2>
          <img style={{ maxWidth: "500px" }} src="help/image012.png" />
          The When tab allows you to filter crimes based on a three date ranges:
          <ol>
          ...
          <ul>
            <li>
              <strong>Mouse</strong> - Use the scroll wheel to zoom in and out.
            </li>
            <li>
              <strong>Touch Screen / Mobile / Tablet</strong> - Pinch to zoom in
              or out.
            </li>
          </ul>
          ...
          <ul>
            <li>
              <strong>Mouse</strong> - Click and hold on the map, then drag the
              cursor.
            </li>
            <li>
              <strong>Touch Screen / Mobile / Tablet</strong> - Drag your finger
              across the map.
            </li>
          </ul>
          ...
          <ul>
            <li>
              ...
              <ul>
                ...
                <li>
                  <strong>Icon</strong> - Represents the predominant offense in
                  that location.
                </li>
              </ul>
            </li>
          ...
          <ul>
            <li>
              <strong>Single Feature</strong> - Clicking on a crime symbol will
              display a popup with details about that specific feature.
            </li>
            <li>
          ...
          <div>
            ...
            <ul>
              <li>
                The popup will show the total number of offenses in that cluster
                and the predominant offense type.
              </li>
              <li>
          ...
          <p>
            ...
            information about that specific crime, allowing you to view details
            for individual incidents within the cluster. When viewing the
            details of a specific offense from the cluster list:
            <ul>
              <li>
                Use the &lt; &gt; buttons in the bottom-left corner of the popup
                to move to the previous or next offense in the list.
              </li>
              <li>
                To return to the full list of offenses, click the button in the
                bottom-right corner (e.g., "5 of 24" in the screenshot).
              </li>
            </ul>
          ...
          <ol>
            <li>
              <strong>Zoom in / Zoom out</strong> - + button zooms in one level,
            ...
            <li>
              ...
              application to access your location. Note: Your device's location
              is not stored.
            </li>
          </ol>
          <h3 id="top-right-tools">Top-Right Tools</h3>
          The following tools are available in the top-right corner of the map:
          <ol>
            <li>
              <strong>Search</strong> – Enter an address and select it from the
              list of suggestions. The map will zoom to that location. Note:
              This tool does not filter the crimes; it only navigates the map.
              <p>
          ...
          In the lower-left corner of the map, you can switch between the Street
          base map and Satellite imagery. Simply click the box to toggle between
          the two views.
          <p>
          ...
          The table provides a detailed view of all crime incidents displayed on
          the map. It allows you to sort and explore individual offenses in a
          tabular format. Using the table, you can quickly find specific crimes,
          view details such as offense type, date, and location, and navigate
          directly to the corresponding feature on the map.
          <img style={{ maxWidth: "1000px" }} src="help/image022.png" />
          <h2 id="sort">Sort by Column</h2>
          To sort the table by a specific column:
          <ol>
            <li>
              <strong>Click the Column Header</strong> – Clicking once will sort
          ...
          <ol>
            ...
            <li>
              Check the columns you want to show or uncheck the columns you want
              to hide.
            </li>
          </ol>
          <p>
          ...
          <ol>
            ...
            <li>The map will zoom to the location of the selected offense.</li>
          </ol>
          <p>
          ...
          access additional information and options related to the application.
          <p>
            ...
            <ul>
              ...
              <li>
                <strong>FAQ</strong> – Frequently Asked Questions about the app.
              </li>
              <li>
                <strong>Data Dictionary</strong> – Displays descriptions of the
                data fields shown for each offense.
              </li>
              <li>
                <strong>Offense Definitions</strong> – Provides definitions for
