...
const FilterSegmentedControl: React.FC<FilterSegmentedControlProps> = ({
  selectedSegment,
  setSelectedSegment,
}) => (
  <calcite-segmented-control
    ...
    oncalciteSegmentedControlChange={(
      event: HTMLCalciteSegmentedControlElement["calciteSegmentedControlChange"],
    ) => {
      setSelectedSegment(
